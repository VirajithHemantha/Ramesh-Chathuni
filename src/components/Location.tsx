...
export const Location: React.FC = () => {
  ...
  const liveLocationUrl = "https://maps.app.goo.gl/98EkYrGoAFAM5X9dA";
          ...
          <div className="bg-[#1D3557]/90 backdrop-blur-2xl p-10 sm:p-14 lg:p-16 rounded-[2.5rem] shadow-[0_30px_60px_rgba(0,0,0,0.3)] border border-brand-primary-light/30 lg:translate-x-12 relative overflow-hidden group">
            ...
            <div className="mb-10 relative z-10">
              ...
              <div className="flex items-start gap-5 mt-10">
                ...
                <div>
                  <p className="text-2xl font-serif text-white mb-1">Senuri Grand Castello</p>
                  <p className="text-[11px] uppercase tracking-[0.2em] font-medium text-blue-100/60 leading-relaxed mb-6">Divulapitiya, Sri Lanka</p>
