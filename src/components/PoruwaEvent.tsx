            ...
            >
              ...
              <div className="relative space-y-10 ml-10 sm:ml-12 border-l-[1.5px] border-poruwa-primary/40 pl-10 sm:pl-12 py-4">
                ...
                <div className="relative group">
                  ...
                  <div>
                    <h4 className="font-serif text-2xl sm:text-3xl text-stone-800 mb-1 group-hover:text-poruwa-primary transition-colors duration-500">Friday, August 14</h4>
                    <p className="text-stone-500/80 text-[10px] sm:text-[11px] uppercase tracking-[0.2em] font-bold">Senuri Grand Castello, Divulapitiya</p>
                  </div>
                </div>
                ...
                <div className="relative group">
                  ...
                  <div>
                    ...
                    <p className="text-stone-500/80 text-[10px] sm:text-[11px] uppercase tracking-[0.2em] font-bold">Arrivals & Welcome</p>
                  </div>
                </div>
                ...
                <div className="relative group">
                  ...
                  <div>
                    <h4 className="font-serif text-xl sm:text-2xl text-stone-800 mb-1 group-hover:text-poruwa-primary transition-colors duration-500">10:00 AM</h4>
                ...
                <div className="relative group">
                  ...
                  <div>
                    ...
                    <p className="text-stone-500/80 text-[10px] sm:text-[11px] uppercase tracking-[0.2em] font-bold">Wedding Lunch</p>
                  </div>
                </div>
                ...
                <div className="relative group">
                  ...
                  <div>
                    ...
                    <p className="text-stone-500/80 text-[10px] sm:text-[11px] uppercase tracking-[0.2em] font-bold">Conclusion</p>
                  </div>
                </div>
